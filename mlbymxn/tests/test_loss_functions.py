...
class TestSquaredLoss(TestCase):
    ...
    def test_predict(self):
        self.testee.theta = np.array([-3.6303, 1.1664])
    ...
    def test_loss_function(self):
        ...
        self.testee.theta = np.zeros((self.n,))
        ...
        self.testee.theta = np.array([-1, 2])
        got = self.testee.loss_function(self.testee.theta, self.X, self.y)
    ...
    def test_check_gradient(self):
        self.testee.theta = np.random.rand(self.n) - 0.5
        got = check_grad(
...
class TestSquaredLossWithL2Reg(TestCase):
    ...
    def test_loss_function(self):
        # theta is initialized by test value
        self.testee.theta = np.ones((self.n,))
        got = self.testee.loss_function(self.testee.theta, self.X, self.y)
...
class TestLogLoss(TestCase):
    ...
    def test_predict(self):
        self.testee.theta = np.array([-25.1613, 0.2062, 0.2015])
    ...
    def test_loss_function(self):
        ...
        # theta is initialized by test value
        self.testee.theta = np.array([-24, 0.2, 0.2])
        got = self.testee.loss_function(self.testee.theta, self.X, self.y)
